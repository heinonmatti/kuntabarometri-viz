...
def render(csv_path: Path, cfg: dict, dest: Path) -> Path:
    ...
    <body>
      <header>
        ...
        <p class="method-note"><strong>Huom. aikasarjojen keskiarvojen laskenta:</strong> Arvot lasketaan tällä sivustolla vastaustasolla: kaikki teeman alakysymyksien vastaukset yhdistetään ja niistä lasketaan keskiarvo. Tämä on ainoa tapa saada vertailukelpoinen aikasarja vuosille 2022–2026, sillä Suomen Yrittäjät julkaisee <a href="https://survey.taloustutkimus.fi/dashboard/kuntabarometri_2026/" target="_blank" rel="noopener noreferrer">lähdesivustolla</a> tarkemman, vastaajatasolla lasketun teemaindeksin (vastaajan oma keskiarvo teemansa kysymyksistä) vain uusimmasta vuodesta. Siksi täsmälliset keskiarvolukemaat saattavat poiketa kuntaraporteista, mutta trendit ja eri alueiden väliset erot pätevät suhteessa toisiinsa.</p>
      </header>
      <div class="controls">
